  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-50 via-orange-50 to-amber-100 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto bg-linear-to-r from-orange-600 to-orange-700 text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 text-sm sm:text-base"
              >
                ...
                <div className="block md:hidden space-y-4">
                  {filteredQuotes.map((quote: Quote, index: number) => {
                    ...
                    return (
                      ...
                      >
                        {/* Mobile Card Header */}
                        <div className="bg-linear-to-r from-orange-100 to-amber-100 p-4 border-b-2 border-orange-200">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-linear-to-br from-orange-600 to-orange-800 text-white rounded-lg flex items-center justify-center font-black shadow-md">
                        ...
                        >
                          <div className="flex gap-4">
                            ...
                            <div className="shrink-0">
                              <div className="w-16 h-16 bg-linear-to-br from-orange-600 to-orange-800 text-white rounded-xl flex items-center justify-center font-black shadow-lg text-2xl">
                                {quote.name?.charAt(0).toUpperCase() || "?"}
                              </div>
                            </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center space-x-3">
                                <div className="w-10 h-10 bg-linear-to-br from-orange-600 to-orange-800 text-white rounded-lg flex items-center justify-center font-black shadow-md shrink-0">
                                  {quote.name?.charAt(0).toUpperCase() || "?"}
                                </div>
      ...
      <AlertDialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
        <AlertDialogContent className="bg-white border-2 border-orange-200 max-w-3xl max-h-[90vh] overflow-y-auto scrollbar-hide">
          <AlertDialogHeader>
